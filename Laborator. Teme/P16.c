/**
 * 16. Creati o lista ce contine un anumit numar de numere reale. Scrieti o
 * functie ce introduce un nod ce contine media fiecaror doua noduri vecine,
...
int main() {
	printf(
		"16. Creati o lista ce contine un anumit numar de numere reale. "
		"Scrieti o functie ce introduce un nod ce contine media fiecaror doua "
		"noduri vecine, intre cele doua noduri.\n");
 ...
 * a carui valoare este media valorilor nodurilor vecine initiale
 * @param node
 */
void insert_averages(List list) {
	...
	while (current->next) {
		...
		node->value = (second->value + current->value) / 2;
		node->next = second;
